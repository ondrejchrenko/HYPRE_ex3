...
//   HYPRE_SetGpuAwareMPI(gpu_aware_mpi);
   ...
   /* 3. Set up a Struct Matrix */
   {
      ...
      values   = hypre_TAlloc(HYPRE_Real, nvalues, HYPRE_MEMORY_HOST);
      d_values = hypre_TAlloc(HYPRE_Real, nvalues, HYPRE_MEMORY_DEVICE);
      ...
      hypre_TMemcpy(d_values, values, HYPRE_Real, nvalues, HYPRE_MEMORY_DEVICE, HYPRE_MEMORY_HOST);
